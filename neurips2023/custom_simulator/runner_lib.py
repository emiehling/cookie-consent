...
class Runner(object):
    ...
    def _set_up(self, eval_mode):
        ...
        # This could involve initializing variables if your agent uses a TensorFlow model.
        # If your agent is using tf.keras, this is typically handled automatically.
    ...
    def _update_episode_metrics(self, episode_length, episode_time, episode_reward):
...
class EvalRunner(Runner):
    ...
    def __init__(self, base_dir,
                 ...
                 test_mode=False,
                 **kwargs):
        # Pass the base_dir and other arguments to the superclass Runner
        super(EvalRunner, self).__init__(base_dir=base_dir, create_agent_fn=create_agent_fn, env=env, **kwargs)
